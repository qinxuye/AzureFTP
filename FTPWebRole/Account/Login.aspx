<%@ Page Title="登录" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="FTPWebRole.Account.Login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Panel ID="FtpAccountLogin" runat="server">
        ...
        <div class="accountInfo">
            ...
            <p class="submitButton">
                <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="登录" 
                    ValidationGroup="LoginUserValidationGroup" onclick="FtpAccount_Login"/>
            </p>
        </div>
    </asp:Panel>
</asp:Content>
